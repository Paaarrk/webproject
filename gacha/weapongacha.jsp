        ...
        <table class="table table-bordered table-hover" style="margin-top:2%" id="itemlist">
            ...
            <tbody style="text-align: center">
                <tr>
                    ...
                    <td><img src="../asset/img/161.jpg"></td>
                    <td style="color: #4ee462; background: #888888">레이피어</td>
                    <td>1%</td>
                </tr>
                <tr>
                    <td style="color: #eef109; background: #888888"">유니크</td>
                    <td><img src="../asset/img/141.jpg"></td>
                    <td style="color: #eef109; background: #888888">네일건</td>
                    <td>1.5%</td>
                </tr>
                <tr>
                    <td style="color: #eef109; background: #888888"">유니크</td>
                    <td><img src="../asset/img/142.jpg"></td>
                    <td style="color: #eef109; background: #888888">구르카</td>
                    <td>1.5%</td>
                </tr>
            </tbody>
        </table>
